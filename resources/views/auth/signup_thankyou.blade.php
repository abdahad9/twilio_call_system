...
<html lang="en" dir="ltr">
    <head>
        ...
        <!-- Title -->
        <title>Thank you for subscribing NoteTakerPro</title>

        <!--Favicon -->
        <link rel="icon" href="{{ asset('public') }}/backend/assets/images/brand/favicon.ico" type="image/x-icon"/>

        <!-- Bootstrap css -->
        <link href="{{ asset('public') }}/backend/assets/plugins/bootstrap/css/bootstrap.css" rel="stylesheet" />

        <!-- Style css -->
        <link href="{{ asset('public') }}/backend/assets/css/style.css" rel="stylesheet" />

        <!-- Dark css -->
        <link href="{{ asset('public') }}/backend/assets/css/dark.css" rel="stylesheet" />

        <!-- Skins css -->
        <link href="{{ asset('public') }}/backend/assets/css/skins.css" rel="stylesheet" />

        <!-- Animate css -->
        <link href="{{ asset('public') }}/backend/assets/css/animated.css" rel="stylesheet" />
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-7 col-lg-4">
                                    <div class="error-logo">
                                        <a href="{{ route('login') }}"><img src="{{ asset('public') }}/backend/assets/images/brand/note-01.png" class="header-brand-img dark-logo" alt="logo"></a>
                                    </div>
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            <div class="text-center  mb-6">
                                                <h2 class="mb-2">Thank you for signing up</h2>
                                            </div>
                            ...
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                                ...
                                                <!-- <div class="col-6 text-right mt-1">
                                                    <a href="forgot-password-1.html" class="text-muted">Back to Login</a>
                                                </div> -->
                                                <div class="col-12 mt-5">
                                                    <a href="{{route('login')}}" class="btn btn-lg btn-primary btn-block">Go To Login</a>
                                                </div>
                                            </div>

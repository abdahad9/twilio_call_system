        ...
        <tr style="background-color: #fff">
           <td style="font-weight: bold;font-size: 18px; padding-top: 5px; padding-bottom: 5px;padding-left: 10px;text-align: left">
            @if($details['type'] == 'user')
              Thank you for signing up. To login please click here
            @else
          ...
          <!-- <tr style="border-top: 1px solid #dfdfdf; background-color: #fff">
           <td rowspan="2" style="white-space: nowrap;padding-top: 5px; padding-bottom: 5px;padding-right: 10px;text-align: right">
                <a href="{{route('login')}}" target="_blank" style="padding: 8px 12px; border: 1px solid #ED2939;border-radius: 2px;font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;text-decoration: none;font-weight:bold;display: inline-block;">
                          Login             
                      </a>
           </td>
         </tr>  -->

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Get a Virtual Number For Your Business Today</title>
                   ...
                   <div style="width: 32%; margin-left:80px;">
                    ...
                    <div style="width: 68%">
                        <div class="d-flex flex-column bd-highlight mb-3">
                          ...
                          <div class="bd-highlight">
                              <img style="width: 90%; height:580px; margin-top:24px;" src="{{ asset('public') }}/backend/assets/notetakergif.gif" alt="No GIF">
                          </div>
                        </div>
                    </div>
               </div>

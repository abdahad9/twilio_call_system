    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    @foreach(isset($static_pages) ? $static_pages : [] as $page)
                        ...
                        @endif
                        @if ((@getUser()->email!='marc@rezosystems.com' && @getUser()->email!='programmer@rezosystems.com') && $page->title=="Terms of Use") 
                            <?php continue; ?>
            ...
            @if(config('site.private_waters'))
                ...
                @if (config('site.private_waters_setting')=='built_in')
                
                <li class="treeview {{ request()->is('*pw/pwrivers*', '*pw/pwbeats*') ? 'active' : '' }}">
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ request()->is('*pw/pwrivers*') ? 'active' : '' }}">
                            <a href="{{ route('pw.pwrivers.index') }}">Rivers</a>
                        </li>
                        <li class="{{ request()->is('*pw/pwbeats*') ? 'active' : '' }}">
                            <a href="{{ route('pw.pwbeats.index') }}">Beats</a>
                        </li>
                    </ul>
                </li>
            ...
            @if(isSuperAdmin())
                <li class="treeview {{ request()->is('settings*') || request()->is('admin/users*') ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @if(config('site.term_of_use_accepted'))
                        <li>
                            <a data-toggle="modal" data-target="#terms-of-use-accepted" href="javascript:void">
                                Terms of Use
                            </a>
                        </li>
                        @endif

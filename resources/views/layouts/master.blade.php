...
<html lang="en" dir="ltr">
    <head>
        <!-- Meta data -->
        <meta charset="UTF-8">
        <title>NoteTakerPro - User Panel | Get a Virtual Number For Your Business Today</title>
        <meta charset="utf-8">
    ...
    <script src="{{ asset('public') }}/js/browser-calls.js" defer></script>
        ...
        <!--Sidemenu css -->
        <link href="{{ asset('public') }}/backend/assets/css/sidemenu.css" rel="stylesheet">

        <!-- P-scroll bar css-->
        <link href="{{ asset('public') }}/backend/assets/plugins/p-scrollbar/p-scrollbar.css" rel="stylesheet" />
        ...
        <link href="{{ asset('public') }}/backend/assets/plugins/morris/morris.css" rel="stylesheet" />

        <!-- INTERNAL Data table css -->
        <link href="{{ asset('public') }}/backend/assets/plugins/datatable/dataTables.bootstrap4.min.css" rel="stylesheet" />
        <style type="text/css">

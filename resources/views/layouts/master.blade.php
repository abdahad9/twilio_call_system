...
<html lang="en" dir="ltr">
    <head>
        ...
        {{-- <script src=" /js/app.js" defer></script> --}}
         <script src="http://eed7-119-160-100-44.ngrok.io/js/manifest.js"></script>
            <script src="http://eed7-119-160-100-44.ngrok.io/js/vendor.js"></script>
    {{-- <script src="/js/browser-calls.js"></script> --}}
    <script src="http://eed7-119-160-100-44.ngrok.io/js/browser-calls.js" defer></script>

                                    ...
                                    <form class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="total_number" placeholder="Total Number">
                                            </div>
                                            <div class="form-group">
                                                <label>Total Calling Minute</label>
                                                <input class="form-control" type="text" name="calling_minute" placeholder="Total Calling Minute">
                                            </div>
                                            <div class="form-group">
                                                <label>Total Recording Minute</label>
                                                <input class="form-control" type="text" name="recording_minute" placeholder="Total Recording Minute">
                                            </div>
                                        </div>
                                        <a href="{{ route('plan.') }}" class="btn btn-primary">Create</a>
                                    </form>
                                </div>
                            </div>
                        </div>

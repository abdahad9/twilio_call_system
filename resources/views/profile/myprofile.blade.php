                                                                ...
                                                                <table class="table mb-0">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td class="py-2 px-0">{{ config('site.user_name') }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="py-2 px-0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="py-2 px-0">English, Italian</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="py-2 px-0">
                                                                                <span class="font-weight-semibold w-50">Website </span>
                                                                            </td>
                                                                            <td class="py-2 px-0">heygotomarketing.com</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="py-2 px-0">
                                                                                <span class="font-weight-semibold w-50">Email </span>
                                                                            </td>
                                                                            <td class="py-2 px-0">{{ config('site.user_email') }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="py-2 px-0">
                                                                                <span class="font-weight-semibold w-50">Phone </span>
                                                                            </td>
                                                                            <td class="py-2 px-0">{{ config('site.user_Phone') }}</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
